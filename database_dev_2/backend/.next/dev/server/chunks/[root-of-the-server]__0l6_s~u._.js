...
async function GET(request) {
    ...
    try {
        ...
        const formatted = customers.map((customer)=>{
            const lastSale = customer.sales.map((s)=>s.sales_date).sort((a, b)=>new Date(b).getTime() - new Date(a).getTime())[0];
            return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0l6_s~u._.js.map